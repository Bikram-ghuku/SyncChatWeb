			...
			<div className='h-screen w-full'>
				<div className="relative isolate pt-14 ">
					...
					<div className=" w-full flex items-center justify-center">
						<Image src="/demo.png" alt="demoPicture" width={900} height={900} className='absolute top-[24rem]'/>
					</div>
				</div>
			</div>
			<div className='h-screen w-full'>
				...
				<div className='flex flex-row pt-[10rem] absolute'>
					<div className='flex-1'>
						<Image src='/demo_mob.png' alt='mobileDemo' width={375} height={666} className='absolute left-[10rem]'/>
					</div>
					<div className='flex flex-1 flex-col mb-20 mr-20 mt-20'>
						<div>
							...
							With the implementation of Advanced Encryption Standards (AES) and the availability of open-source code for the chat application, 
							bugs are detected, reported, and promptly addressed by a diverse community of users and developers. 
							</div>							
						</div>
					</div>
				</div>
